...
var canUseAsyncFileRead = () => isSupportJSPI();

// src/workers-code/generated.ts
var LIBLLAMA_VERSION = "b168-e8e134f";
...
var Wllama = class {
  ...
  createEmbedding(options) {
    return __async(this, null, function* () {
      ...
      return yield this.getRespose(options, false, result.request_id);
    });
  }
  ...
  getRespose(options, isStream, requestId) {
    return __async(this, null, function* () {
      var _a, _b;
