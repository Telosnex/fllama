...
const WLLAMA_PATHS = {
    'jspi/single-thread/wllama.wasm': new URL('./wllama/jspi-single-thread/wllama.wasm', import.meta.url).href,
    'asyncify/single-thread/wllama.wasm': new URL('./wllama/asyncify-single-thread/wllama.wasm', import.meta.url).href,
    'asyncify/multi-thread/wllama.wasm': new URL('./wllama/asyncify-multi-thread/wllama.wasm', import.meta.url).href,
};
